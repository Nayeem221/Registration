...
const Register = () => {
  ...
  return (
   ...
   <label className='text-[28px] font-nunito font-semibold text-[#444B59] mb-[16px]' >Username</label>
   <input className='lg:py-[24px] lg:px-[32px] py-[16px] px-[23px] rounded-[20px] lg:rounded-[80px] border-2 border-[#789ADE] text-black lg:mb-[36px] outline-none' placeholder='deniel123@gmail.com' type="text" />
   <label className='text-[28px] font-nunito font-semibold text-[#444B59] mb-[16px]' >Password</label>
  ...
  />
  <label for="remember-me" classname="text-gray-600">Remember me</label>
</div>
